...
class UnifiedAnalyzer:
    ...
    async def analyze_project(
        self, serena_report: Dict[str, Any], ast_report: Dict[str, Any]
...
async def merge_analyses(serena_report_path: str, ast_report_path: str, project_path: str) -> UnifiedProjectAnalysis:
    """
    融合 Serena 和 AST 分析结果
